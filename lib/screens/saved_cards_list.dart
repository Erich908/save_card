        ...
        child: TextButton(
          onPressed: () {
            context.pushNamed(SaveCard.route, pathParameters: {
              'id': (listOfCards.isNotEmpty
                      ? listOfCards.last.id + 1
                      : 1)
                  .toString()
            });
          },
        ...
        children: [
          Expanded(
            child: ListView(
              ...
              children: [
                Text('${listOfCards.length} Card${listOfCards.length == 1 ? '' : 's'}'),
